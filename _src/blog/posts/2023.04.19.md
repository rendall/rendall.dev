...
The pre-commit hook will run after you type `git commit` but before committing. Use this to ensure the last commit is _not_ prefixed by `WIP:`. If it has the `WIP:` prefix, echo an error and prevent the commit:
